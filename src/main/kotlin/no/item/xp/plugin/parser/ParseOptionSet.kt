...
fun parseOptionSet(inputNode: Node, mixins: List<ObjectTypeModel>): OptionSetField? {
...
private fun parseOptionSetFieldOption(optionNode: Node, mixins: List<ObjectTypeModel>): ObjectField {
  val optionComment = optionNode.getChildNodeAtXPath("label")?.textContent
  val itemsNode = optionNode.getChildNodeAtXPath("items")

  val fields: List<ObjectTypeModelField> = itemsNode
